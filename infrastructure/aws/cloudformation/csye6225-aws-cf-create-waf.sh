...
create=$(aws cloudformation create-stack --stack-name $sn --template-body file://../csye6225-cf-waf.json --capabilities CAPABILITY_NAMED_IAM --parameters ParameterKey=ourLoadBalancer,ParameterValue=$ELB)
